...
BOOL CSnakeApp::InitInstance()
{
	...
	if (!ProcessShellCommand(cmdInfo))
		return FALSE;
    m_pMainWnd->SetWindowText("Ì°³ÔÉßÐ¡ÓÎÏ·");
	m_pMainWnd->SetIcon(AfxGetApp()->LoadIcon(IDI_ICON6),true);
	// The one and only window has been initialized, so show and update it.
    m_pMainWnd->SetWindowPos(NULL,windows_x,windows_y,windows_w,windows_h,SWP_NOZORDER);
